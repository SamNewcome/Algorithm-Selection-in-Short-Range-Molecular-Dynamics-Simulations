#!/bin/bash
#SBATCH --job-name=RT_RF # specifies a user-defined job name
...
mpirun -np 40 $HOME/AutoPas/build-MPI2/examples/md-flexible/md-flexible --yaml-filename rayleighTaylor.yaml --model-filename model.pkl
