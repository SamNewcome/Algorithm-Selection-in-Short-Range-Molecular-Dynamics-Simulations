#!/bin/bash
#SBATCH --job-name=EL_RF # specifies a user-defined job name
...
#SBATCH --time=02:00:00 # maximum wall clock limit for job execution
...
mpirun -np 6 $HOME/AutoPas/build-MPI2/examples/md-flexible/md-flexible --yaml-filename explodingLiquid.yaml --model-filename model.pkl
