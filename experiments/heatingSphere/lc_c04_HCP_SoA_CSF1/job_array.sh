#!/bin/bash
#SBATCH --job-name=HS_LCC04_HCP # specifies a user-defined job name
...
mpirun -np 1 $HOME/AutoPas/build-MPI2/examples/md-flexible/md-flexible --yaml-filename heatingSphere.yaml
