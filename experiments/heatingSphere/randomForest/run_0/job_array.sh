#!/bin/bash
#SBATCH --job-name=HS_RF # specifies a user-defined job name
...
mpirun -np 1 $HOME/AutoPas/build-MPI2/examples/md-flexible/md-flexible --yaml-filename heatingSphere.yaml --model-filename model.pkl
